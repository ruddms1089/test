...
<c:set var="registerFlag" value="${empty noticVO.num ? '등록' : '수정'}"/>
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/notic/addNotic.do' : '/notic/updateNotic.do'}"/>";
    frm.submit();
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
	   ...
	   <tr>
		...
		<tr>
			<th>EMP_NUMBER</th>
			<td>
				<form:input path="empNumber" cssClass="txt"/>
		...
		<tr>
			<th>DATES</th>
			<td>
				<form:input path="dates" cssClass="txt"/>
